namespace Gpm.LogViewer.Internal
{
    ...
    public static class LogConst
    {
        ...
        public const string LOGFILE_NAME                            = "GpmLogViewerLog_{0}.txt";
        public const string LOGFILE_MAIL_NAME                       = "GpmLogViewerLogForMail.txt";
    ...
    public static class ConsoleViewConst
    {
        ...
        public const string SAVE_FILE_FAILED                        = "SaveLogFile failed";
        public const string SAVE_FILE_SUCCEEDED                     = "SaveLogFile succeeded : {0}";
